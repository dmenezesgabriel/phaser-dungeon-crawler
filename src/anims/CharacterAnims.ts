...
export const createCharacterAnims = (anims: Phaser.Animations.AnimationManager) => {
  anims.create({ key: "faune-idle-down", frames: [{ key: "faune", frame: "sprites/walk-down/walk-down-3.png" }] });

  anims.create({ key: "faune-idle-up", frames: [{ key: "faune", frame: "sprites/walk-up/walk-up-3.png" }] });

  anims.create({ key: "faune-idle-side", frames: [{ key: "faune", frame: "sprites/walk-side/walk-side-3.png" }] });
